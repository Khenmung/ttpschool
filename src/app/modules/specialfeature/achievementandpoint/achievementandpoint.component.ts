...
@Component({
  selector: 'app-achievementandpoint',
  templateUrl: './achievementandpoint.component.html',
  styleUrls: ['./achievementandpoint.component.scss']
})
export class AchievementandpointComponent implements OnInit {
  PageLoading = true;
