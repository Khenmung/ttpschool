...
export class QuestionComponent implements OnInit {
  ...
  UpdateOrSave(row) {
    ...
    let checkFilterString = "Question eq '" + globalconstants.encodeSpecialChars(row.Question) + "'";
    ...
    this.QuestionBankData.Question = globalconstants.encodeSpecialChars(row.Question);
  ...
  GetSyllabusDetail() {
    ...
    list.PageName = "SyllabusDetails";
    list.lookupFields = ["QuestionBanks($select=QuestionBankId,SyllabusId,Question,Diagram,DifficultyLevelId;$expand=StorageFnPs($select=FileId,FileName))"]
    list.filter = [filterStr];
    this.QuestionBankList = [];
    this.dataservice.get(list)
      .subscribe((data: any) => {
