...
@Component({
  selector: 'app-examstudentresult',
  templateUrl: './examstudentresult.component.html',
  styleUrls: ['./examstudentresult.component.scss']
})
export class ExamstudentresultComponent implements OnInit {
  ...
  StandardFilter = '';
  loading = false;
  ExamStudentResults: IExamStudentResult[] = [];
  CurrentBatchId = 0;
  Grades = [];
  ExamStatus = [];
  ExamNames = [];
